# go-mutesting [![GoDoc](https://godoc.org/github.com/paranthamansam/go-mutesting?status.png)](https://godoc.org/github.com/paranthamansam/go-mutesting) [![Build Status](https://travis-ci.org/paranthamansam/go-mutesting.svg?branch=master)](https://travis-ci.org/paranthamansam/go-mutesting) [![Coverage Status](https://coveralls.io/repos/paranthamansam/go-mutesting/badge.png?branch=master)](https://coveralls.io/r/paranthamansam/go-mutesting?branch=master)
...
```bash
go-mutesting github.com/paranthamansam/go-mutesting/...
```
...
```bash
go get -t -v github.com/paranthamansam/go-mutesting/...
```
...
```bash
go-mutesting parse.go example/ github.com/paranthamansam/go-mutesting/mutator/...
```
...
Alternatively the `--exec` argument can be used to invoke an external exec command. The [/scripts/exec](/scripts/exec) directory holds basic exec commands for Go projects. The [test-mutated-package.sh](/scripts/exec/test-mutated-package.sh) script implements all steps and almost all features of the built-in exec command. It can be for example used to test the [github.com/paranthamansam/go-mutesting/example](/example) package.

```bash
go-mutesting --exec "$GOPATH/src/github.com/paranthamansam/go-mutesting/scripts/exec/test-mutated-package.sh" github.com/paranthamansam/go-mutesting/example
```
...
```diff
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.0" with checksum b705f4c99e6d572de509609eb0a625be
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.1" with checksum eb54efffc5edfc7eba2b276371b29836
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.2" with checksum 011df9567e5fee9bf75cbe5d5dc1c81f
--- /home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go
+++ /tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.3
@@ -16,7 +16,7 @@
        }
...
+
        ...
        n++
FAIL "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.3" with checksum 82fc14acf7b561598bfce25bf3a162a2
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.4" with checksum 5720f1bf404abea121feb5a50caf672c
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.5" with checksum d6c1b5e25241453128f9f3bf1b9e7741
--- /home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go
+++ /tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.6
@@ -24,7 +24,6 @@
        n += bar()
...
FAIL "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.6" with checksum 5b1ca0cfedd786d9df136a0e042df23a
PASS "/tmp/go-mutesting-422402775//home/zimmski/go/src/github.com/paranthamansam/go-mutesting/example/example.go.8" with checksum 6928f4458787c7042c8b4505888300a6
...
```bash
go-mutesting --blacklist example.blacklist github.com/paranthamansam/go-mutesting/example
```
...
Each mutator must implement the `Mutator` interface of the [github.com/paranthamansam/go-mutesting/mutator](https://godoc.org/github.com/paranthamansam/go-mutesting/mutator#Mutator) package. The methods of the interface are described in detail in the source code documentation.

Additionally each mutator has to be registered with the `Register` function of the [github.com/paranthamansam/go-mutesting/mutator](https://godoc.org/github.com/paranthamansam/go-mutesting/mutator#Mutator) package to make it usable by the binary.

Examples for mutators can be found in the [github.com/paranthamansam/go-mutesting/mutator](https://godoc.org/github.com/paranthamansam/go-mutesting/mutator) package and its sub-packages.
